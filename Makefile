...
SRCMODULES := main.cpp application.cpp vk_extensions.cpp vk_instance.cpp vk_device.cpp vk_debug_messenger.cpp timer.cpp vk_swapchain.cpp vk_engine.cpp vk_graphic_pipeline.cpp vk_pipeline_states.cpp vk_surface.cpp error_manager.cpp file_manager.cpp global_settings.cpp vk_settings.cpp vk_vertex_binding.cpp vk_command_manager.cpp vk_regulator.cpp base_camera.cpp vk_camera.cpp window.cpp vk_descriptor_set.cpp vk_descriptor_pool.cpp cmd_command.cpp cmd_instruction.cpp cmd_mouse.cpp cmd_exit.cpp cmd_move_camera.cpp cmd_rotate_camera.cpp input_controller.cpp input_keyboard.cpp input_mouse.cpp vk_buffer_builder.cpp vk_image_builder.cpp vk_mesh_loader.cpp vk_texture_loader.cpp vk_model_storage.cpp binary_ifstream.cpp texture.cpp vk_buffer.cpp
...
debug: $(addprefix $(PREFIX), $(OBJMODULES))
	$(CXX) $(CXXFLAGS) $(SANITIZER) $(LDFLAGS) $^ -o $(PREFIX)$@
